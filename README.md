...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-bush-0384
```

A live public deployment of this template is available at [https://square-bush-0384.templates.workers.dev](https://square-bush-0384.templates.workers.dev)
